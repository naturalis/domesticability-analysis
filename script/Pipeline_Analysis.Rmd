...
# Remove traits without any information gain (only consist of one value or is an incomplete case (Habitat/Diet Breadth))
dataset <- subset(dataset, select = -c(Motility, ParentalCare, X12.2_Terrestriality, X6.1_DietBreadth, X12.1_HabitatBreadth))
